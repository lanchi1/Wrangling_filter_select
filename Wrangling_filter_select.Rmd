...
It's always a good idea to do some recon work first. What do the data look like? How many observations and variables do we have? What are the variable names?
   ...
   It looks like this data is showing genres of movies ranging from action to shorts from 1939 until the 2002, it shows the title of the movie the year of it, the length of the movie, the budget to make the movie and the rating of the movie to see if the people like it  
...
- What is the average movie rating? The average movie rating at 5.9

- What is the median budget for a movie? The median budget for this movie is at a 3million dollar .

But after looking at all of the movies recorded here, the more precise questions might turn out to be:

- What is the average rating *of movies longer than 60 minutes?* The average rating of movie longer than 60 minutes is at about 90 minutes to be exact. 
...
1. How many movies were released in 1995?
 ...
 The amount of movies were released in 1995
